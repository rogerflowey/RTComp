; ModuleID = '/Users/theunknownthing/RTComp/bench/audio_dsp.cpp'
...
define void @audio_callback(i32 noundef %0) #0 {
...
3:                                                ; preds = %1
  tail call fastcc void @_ZL11heavy_allocv()
  br label %4
...
define internal fastcc void @_ZL10apply_gainPfmf() unnamed_addr #1 {
  br label %2
...
2:                                                ; preds = %0, %2
  ...
  store float %7, ptr %4, align 4, !tbaa !10
  %8 = add nuw nsw i64 %3, 1
  %9 = icmp eq i64 %8, 256
  br i1 %9, label %1, label %2, !llvm.loop !12
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind ssp memory(readwrite, argmem: none, inaccessiblemem: none, target_mem0: none, target_mem1: none) uwtable(sync)
define internal fastcc void @_ZL10map_bufferPfPFvS_E() unnamed_addr #1 {
  br label %2
...
11:                                               ; preds = %7, %9
  ...
  br i1 %13, label %1, label %2, !llvm.loop !14
}

; Function Attrs: mustprogress noinline nounwind ssp uwtable(sync)
define internal fastcc void @_ZL11heavy_allocv() unnamed_addr #0 {
  %1 = tail call dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #9
  tail call void asm sideeffect "", "r,~{memory}"(ptr %1) #10, !srcloc !15
...
4:                                                ; preds = %2
  tail call void @__rtsan_realtime_reset_counts()
  br label %5
...
6:                                                ; preds = %5, %6
  ...
  store <4 x float> %11, ptr %12, align 4, !tbaa !10
  %13 = add nuw i64 %7, 4
  %14 = add nuw nsw <4 x i64> %8, splat (i64 4)
  %15 = icmp eq i64 %13, 256
  br i1 %15, label %16, label %6, !llvm.loop !16
...
27:                                               ; preds = %22, %20
  ...
  tail call void @audio_callback(i32 noundef %28)
  %29 = add nuw nsw i64 %21, 1
  %30 = icmp eq i64 %29, 200000
  br i1 %30, label %18, label %20, !llvm.loop !19

31:                                               ; preds = %18
  %32 = tail call i64 @__rtsan_realtime_enter_count()
  br label %33
...
36:                                               ; preds = %33
  %37 = tail call i64 @__rtsan_realtime_exit_count()
  br label %38

38:                                               ; preds = %36, %33
  %39 = phi i64 [ %37, %36 ], [ 0, %33 ]
  %40 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i64 noundef %34, i64 noundef %39, i64 noundef 200000)
  ret i32 0
}
...
define internal fastcc noundef float @_ZL3mixfff(float noundef %0, float noundef %1) unnamed_addr #5 {
